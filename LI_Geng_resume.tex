...
\item Diverse knowledge in web developing technology, distributed system analysis and architect, and good with multiple programming languages such as C/C++, Java, Common Lisp and Scala;
...
\item Technical lead for dujia.qunar.com: responsible for performance and availability related issues of dujia.qunar.com and ranking 
...
{Beijing, CHINA}
\item Led architect refactoring to enhance site reliability and performance:
  \begin{enumerate}
    \item Improved search list performance by about 200\% with a reduction of 20\% on backend server load;
    \item Improved navigation page performance by an order of magnitude with Cassandra and Spark on the backend of the website for weakly consistent key-value storage and offline distributed computing;
  \end{enumerate}
