...
{Beijing, CHINA}
\item Led search refactoring: improved search performance by about 200\% with a reduction of 20\% on backend server load;
\item Introduced Cassandra and Spark to the backend of the website for weakly consistent key-value storage and offline distributed
 computing, which improved site reliability and performance by an order of magnitude
