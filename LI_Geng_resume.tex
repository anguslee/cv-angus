...
\item Introduced Cassandra to the backend of the website for weekly consistent key-value storage and patternized the development
process for data modules on the website that requires time-consuming computings;
...
\item Hacked open-source Luene search engine, primarily working on the feature of handling search
