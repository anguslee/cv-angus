...
{Beijing, CHINA}
\item Technically responsible for performance and availability related issues of package.qunar.com, as well as the ranking 
quality on the search result;
\item Introduced Cassandra and Spark to the backend of the website for weakly consistent key-value storage and distributed
 computing;
