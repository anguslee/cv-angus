...
\item Good at getting the big picture of projects, and make reasonable compromise between software features,
maintainability and project delivery time;
\item Well-grounded knowledge in computing technologies and master several programming languages.
...
Trilingural & Chinese (Native), English (Proficient), French (Average)
\end{tabular}
...
\item Standardized the development process for cutting in different lines of products.
